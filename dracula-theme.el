...
(let ((colors '((fg1          "#f8f8f2")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
      ...
      (faces '(;; default
               ...
               (highlight :foreground ,fg1 :background ,bg3)
               (hl-line :background  ,bg2)
               (info-quoted-name :foreground ,builtin)
               (info-string :foreground ,str)
               (lazy-highlight :foreground ,bg1 :background ,rainbow-3)
               ...
               ;; isearch
               (isearch :bold t :foreground ,bg1 :background ,rainbow-6)
               ...
               (powerline-evil-emacs-face :inherit powerline-evil-base-face :background ,rainbow-1)
               (powerline-evil-insert-face :inherit powerline-evil-base-face :background ,rainbow-7)
               (powerline-evil-motion-face :inherit powerline-evil-base-face :background ,rainbow-6)
               (powerline-evil-normal-face :inherit powerline-evil-base-face :background ,rainbow-2)
